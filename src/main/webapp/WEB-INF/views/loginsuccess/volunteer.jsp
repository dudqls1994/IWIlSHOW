...
<div id="main" class="container">
   ...
   <table id="noticeTable">
         ...
         <c:forEach items="${list}" var="n">
            ...
            <tr height="35" align="center">
               <td>${n.idx}</td>
               <td>&nbsp;</td>
               <td align="left"><a href="volgoboarduser.do?idx=${n.idx}&name=${name}">${n.name}
               </a></td>
               <td>&nbsp;</td>
               <td>${n.writer}</td>
               <td>&nbsp;</td>
   ...
   <ul class="actions" >
      <li style="padding-top:30px;float:right; padding-right:200px"><a href="volwrite.do?name=${name}" class="button" >글쓰기</a></li>
   </ul>

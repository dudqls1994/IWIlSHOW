...
<section id="two">
	...
	<div class="inner">
		...
		<c:forEach items="${list}" var="n">
			<table class="view_table total-notice">
				...
				<tr>
					...
					<td colspan="10" class="td title bg_view"><input type="text"
						name="name" value="${n.name }" id="name"
				...
				<tr>
					...
					<td colspan="7" class="td_pd51 color7"><input type="text"
						name="writer" id="writer" value="${n.writer}" disabled="disabled"
				...
				<tr>
					<th style="width: 150px; padding: 0.75em" scope="row"
						class="th_bg_wh color7 th3">첨부파일</th>
				...
				<tr>
					<td colspan="10" style="padding: 0">
						<!--  첨부 파일  게시판이면서 이미지일경우(옵션에따라 이미지 표시) --> <!--  첨부 파일  끝 -->


						<div id="article_text">
							<p
								style="font-size: 13pt; word-break: keep-all; font-weight: bold; text-align: center; letter-spacing: 0pt; text-autospace: 0; background: transparent">
								<textarea name="contents" id="contents" rows="9"
									style="background: transparent; padding-left: 0.75em">${n.contents }</textarea>
							</p>
		...
		<ul class="actions">
			<li data-toggle="modal" class="button fit" style="width: 10%"><a
				href="Volounteer.do" style="text-decoration: none">게시글보기</a></li>
		</ul>
	</div>
</section>
</div>
